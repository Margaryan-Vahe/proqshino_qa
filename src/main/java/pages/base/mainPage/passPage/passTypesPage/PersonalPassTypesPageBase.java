...
public abstract class PersonalPassTypesPageBase {
    ...
    // Конструктор класса
    public PersonalPassTypesPageBase(AppiumDriver<MobileElement> appiumDriver) {
        this.appiumDriver = appiumDriver;
    }

    // Методы класса
    @Step("Жду загрузки экрана 'Выберите тип пропуска'")
    public PersonalPassTypesPageBase waitUntilLoaded() {
