...
public class Data {
    ...
    public static final String NO_VALID_INN = "7771111555";
    public static final String RANDOM_EMAIL = "random@email.com";
    ...
    public enum UserTypes {
        ...
        NOT_ACTIVATED_EMPLOYEE_ {
            public String phoneValidValue() {
                return "79330000009";
            }

            public String phoneFullValue() {
                return "+7 (933) 000-00-09";
            }
